...
public class SwaggerConfig {
    ...
    public Docket docket(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.gabrielferreira.spring.usuario.saldo.controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder().title("API Usuário Saldos").description("Controle de gestão referente a usuários.")
