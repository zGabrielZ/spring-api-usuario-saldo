...
//        UsuarioViewDTO usuarioViewDTO = new UsuarioViewDTO(idUsuarioInformado, null,null,null,null);
...
//        when(feriadoNacionalClient.buscarFeriadosNacionais()).thenReturn(Collections.singletonList(feriadoNacionalDTO));
//
//        // Executando e verificando
//        assertThrows(ExcecaoPersonalizada.class, () -> saldoService.depositar(saldoFormDTO));
//        verify(saldoRepositorio,never()).save(any());
