...
//        assertThat(usuarioResultado.cpf()).isEqualTo("33356983040");
...
//        verify(usuarioRepositorio).save(any(Usuario.class));
//        assertThat(usuarioResultado.nome()).isEqualTo("Gabriel Ferreira");
//        assertThat(usuarioResultado.dataNascimento()).isEqualTo(LocalDate.parse("26/12/1997",DTFDIA));
//        assertThat(usuarioResultado.email()).isEqualTo("ferreiragabriel2612@gmail.com");
//        assertThat(usuarioAtualizado.getSenha()).isEqualTo("123456");
//        assertThat(usuarioResultado.cpf()).isEqualTo("76019762033");
//    }
//
//    @Test
